...
export function Layout() {
  ...
  return (
    <div className="fixed inset-0 flex overflow-hidden bg-surface">
      {/* Menu latéral : fixe sur desktop, tiroir coulissant par-dessus le contenu sur mobile */}
      {tiroirOuvert && (
        <div
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex w-64 shrink-0 flex-col bg-panel text-white/90 transition-transform duration-200 sm:static sm:translate-x-0 ${
